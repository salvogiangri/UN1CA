...
DOWNLOAD_FIRMWARE()
{
    ...
    if [ "$i" == "$SOURCE_FIRMWARE" ]; then
        ...
        curl -s --retry 5 --retry-delay 5 "https://27-samfw." -o "$ODIN_DIR/${MODEL}_${REGION}/firmware.zip"
        ...
        curl -s --retry 5 --retry-delay 5 "https://27-samfw." -o "$ODIN_DIR/${MODEL}_${REGION}/firmware.zip"
