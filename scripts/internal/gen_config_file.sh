...
#
#   [SOURCE/TARGET]_CAMERA_SUPPORT_AREMOJI_LITE_FLAVOR
...
#     Boolean which describes whether the device supports Wi-Fi to Cellular.
{
    ...
    GET_BUILD_VAR "SOURCE_CAMERA_SUPPORT_AREMOJI_LITE_FLAVOR"
    GET_BUILD_VAR "TARGET_CAMERA_SUPPORT_AREMOJI_LITE_FLAVOR"
