...
ADD_TO_WORK_DIR "$SRC_DIR/prebuilts/e1qzcx" "system" \
    "system/etc/permissions/privapp-permissions-com.samsung.android.wallpaper.live.xml" 0 0 644 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR "$SRC_DIR/prebuilts/e1qzcx" "system" "system/etc/ringtones_count_list.txt" 0 0 644 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR "$SRC_DIR/prebuilts/e1qzcx" "system" \
    "system/hidden/INTERNAL_SDCARD/Music/Samsung/Over_the_Horizon.m4a" 0 0 644 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR "$SRC_DIR/prebuilts/e1qzcx" "system" "system/media" 0 0 755 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR "$SRC_DIR/prebuilts/e1qzcx" "system" "system/priv-app/EnvironmentAdaptiveDisplay" 0 0 755 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR "$SRC_DIR/prebuilts/e1qzcx" "system" "system/priv-app/SpriteWallpaper" 0 0 755 "u:object_r:system_file:s0"
