...
SOURCE_HAS_CLOCKPACK="$(test -f "$FW_DIR/$SOURCE_FIRMWARE_PATH/system/system/etc/permissions/privapp-permissions-com.samsung.android.app.clockpack.xml" && echo "true" || echo "false")"
