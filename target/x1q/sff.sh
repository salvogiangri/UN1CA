...
# SEC Floating Feature configuration file for Galaxy S20 5G (Qualcomm) (x1q)
...
SEC_FLOATING_FEATURE_GALLERY_SUPPORT_STORYEDITOR=4
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG981JPN
