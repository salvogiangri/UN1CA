...
APPLY_PATCH "system" "system/app/Bluetooth@BP2A.250605.031.A3/Bluetooth.apk" \
    "$SRC_DIR/unica/patches/bluetooth/a2dp_offload/Bluetooth.apk/0001-Disable-SUPPORT_A2DP_OFFLOAD-support.patch" \
    > /dev/null
APPLY_PATCH "system" "system/priv-app/SecSettings/SecSettings.apk" \
    "$SRC_DIR/unica/patches/bluetooth/a2dp_offload/SecSettings.apk/0001-Disable-SUPPORT_A2DP_OFFLOAD-support.patch"

# SEC_PRODUCT_FEATURE_BLUETOOTH_SUPPORT_HEAD_SAR_BACKOFF
LOG "- Applying \"Disable SUPPORT_HEAD_SAR_BACKOFF support\" to apex_payload/app/Bluetooth@BP2A.250605.031.A3/Bluetooth.apk"
APPLY_PATCH "system" "system/app/Bluetooth@BP2A.250605.031.A3/Bluetooth.apk" \
    "$MODPATH/head_sar/Bluetooth.apk/0001-Disable-SUPPORT_HEAD_SAR_BACKOFF-support.patch" \
    > /dev/null
