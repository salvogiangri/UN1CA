...
REMOVE_FROM_WORK_DIR "$WORK_DIR/vendor/etc/midas/SRIBMidas_aiHDR_Global_INT16_V430_sm7325_snpe1502.dlc"
REMOVE_FROM_WORK_DIR "$WORK_DIR/vendor/etc/midas/SRIBMidas_aiHDR_Local_INT16_V430_sm7325_snpe1502.dlc"
REMOVE_FROM_WORK_DIR "$WORK_DIR/vendor/etc/midas/SRIBMidas_aiMOIREREMOVE_Coarse_V900_FP32.caffemodel"
REMOVE_FROM_WORK_DIR "$WORK_DIR/vendor/etc/midas/SRIBMidas_aiMOIREREMOVE_Fine_V900_FP32.caffemodel"
REMOVE_FROM_WORK_DIR "$WORK_DIR/vendor/etc/midas/SRIBMidas_aiUNIFIED_FP16_V610.caffemodel"
REMOVE_FROM_WORK_DIR "$WORK_DIR/vendor/etc/midas/SRIBMQA_aiBLURESTIMATE_V100_FP32.tflite"
...
if ! grep -q "wlan/m526b" "$WORK_DIR/configs/file_context-vendor"; then
    {
        ...
        echo "/vendor/etc/midas/SRIBMidas_aiHDR_Global_INT16_V430_sm7325_snpe1502\.dlc u:object_r:vendor_configs_file:s0"
        echo "/vendor/etc/midas/SRIBMidas_aiHDR_Local_INT16_V430_sm7325_snpe1502\.dlc u:object_r:vendor_configs_file:s0"
        ...
        echo "/vendor/etc/midas/SRIBMQA_aiBLURESTIMATE_V100_FP32\.tflite u:object_r:vendor_configs_file:s0"
...
if ! grep -q "wlan/m526b" "$WORK_DIR/configs/fs_config-vendor"; then
    {
        ...
        echo "vendor/etc/midas/SRIBMidas_aiHDR_Global_INT16_V430_sm7325_snpe1502.dlc  0 0 644 capabilities=0x0"
        echo "vendor/etc/midas/SRIBMidas_aiHDR_Local_INT16_V430_sm7325_snpe1502.dlc  0 0 644 capabilities=0x0"
        ...
        echo "vendor/etc/midas/SRIBMQA_aiBLURESTIMATE_V100_FP32.tflite  0 0 644 capabilities=0x0"
