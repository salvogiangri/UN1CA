...
# SEC Floating Feature configuration file for Galaxy A23 5G (a23x)
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_EDGE=people,task,circle,panel,-edgefeeds,debug,search,phonecolor,off
...
#SEC_FLOATING_FEATURE_COMMON_CONFIG_MDNIE_MODE=
