...
REMOVE_FROM_WORK_DIR "system" "system/etc/permissions/com.sec.feature.cover.sview.xml"
REMOVE_FROM_WORK_DIR "system" "system/etc/permissions/com.sec.feature.cover.xml"
