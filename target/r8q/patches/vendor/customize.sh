...
REMOVE_FROM_WORK_DIR "vendor" "bin/hw/vendor.samsung.hardware.vibrator@2.2-service"
REMOVE_FROM_WORK_DIR "vendor" "etc/init/vendor.samsung.hardware.vibrator@2.2-service.rc"
REMOVE_FROM_WORK_DIR "vendor" "etc/midas/SRIBMidas_aiBLURDETECT_Stage1_V140_FP32.tflite"
REMOVE_FROM_WORK_DIR "vendor" "etc/midas/SRIBMidas_aiBLURDETECT_Stage2_V130_FP32.tflite"
REMOVE_FROM_WORK_DIR "vendor" "etc/midas/SRIBMidas_aiDEBLUR_FP16_V0132.caffemodel"
REMOVE_FROM_WORK_DIR "vendor" "etc/midas/SRIBMidas_aiDENOISE_FP16_V900.caffemodel"
REMOVE_FROM_WORK_DIR "vendor" "etc/midas/SRIBMidas_aiUNIFIED_FP16_V610.caffemodel"
REMOVE_FROM_WORK_DIR "vendor" "lib64/vendor.samsung.hardware.vibrator@2.0.so"
REMOVE_FROM_WORK_DIR "vendor" "lib64/vendor.samsung.hardware.vibrator@2.1.so"
REMOVE_FROM_WORK_DIR "vendor" "lib64/vendor.samsung.hardware.vibrator@2.2.so"
