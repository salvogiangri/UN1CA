...
# SEC Floating Feature configuration file for Galaxy A52 4G (a52q)
...
SEC_FLOATING_FEATURE_AUDIO_CONFIG_SOUNDALIVE_VERSION=eq_custom,uhq_onoff,adapt,spk_stereo,karaoke,dvfs_700000
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_UW_DISTORTION_CORRECTION=120,120,2,19010102,4000,3000,0,0,0,0
SEC_FLOATING_FEATURE_CAMERA_CONFIG_VENDOR_LIB_INFO=beauty.samsung.v4,facial_attribute.samsung.v1,single_bokeh.samsung.v2,dual_bokeh.samsung.v1,scene_detection.samsung.v1,event_detection.samsung.v2,intelligent_guide.samsung.v1,localtm.samsung.v1_1,food.samsung.v1,swldc.samsung.v1,selfie_correction.samsung.v1,smart_scan.samsung.v2,face_landmark.arcsoft.v2_1,swuwdc.arcsoft.v1,mfhdr.arcsoft.v1,llhdr.arcsoft.v1,human_tracking.arcsoft.v2_1,human_segmentation.samsung.v2,image_enhance.arcsoft.v1
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_SWLENS_DISTORTION_CORRECTION=a52q,S5K3L6
...
SEC_FLOATING_FEATURE_GALLERY_CONFIG_LIVEFOCUS_EFFECT_DUAL_BOKEH=BLUR,EFFECT,REFOCUS,PORTRAIT,RELIGHT
